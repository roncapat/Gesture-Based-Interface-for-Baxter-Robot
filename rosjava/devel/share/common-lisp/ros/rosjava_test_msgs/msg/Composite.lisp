...
(cl:defclass <Composite> (roslisp-msg-protocol:ros-message)
  ((a
    :reader a
    :initarg :a
    :type rosjava_test_msgs-msg:CompositeA
    :initform (cl:make-instance 'rosjava_test_msgs-msg:CompositeA))
   (b
    :reader b
    :initarg :b
    :type rosjava_test_msgs-msg:CompositeB
    :initform (cl:make-instance 'rosjava_test_msgs-msg:CompositeB)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Composite>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Composite)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_test_msgs-msg:<Composite> is deprecated: use rosjava_test_msgs-msg:Composite instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <Composite>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosjava_test_msgs-msg:a-val is deprecated.  Use rosjava_test_msgs-msg:a instead.")
  (a m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Composite>)))
  ...
  (cl:format cl:nil "# composite message. required for testing import calculation in generators~%CompositeA a~%CompositeB b~%~%================================================================================~%MSG: rosjava_test_msgs/CompositeA~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: rosjava_test_msgs/CompositeB~%# copy of geometry_msgs/Point for testing~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Composite)))
  "Returns full string definition for message of type 'Composite"
  (cl:format cl:nil "# composite message. required for testing import calculation in generators~%CompositeA a~%CompositeB b~%~%================================================================================~%MSG: rosjava_test_msgs/CompositeA~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: rosjava_test_msgs/CompositeB~%# copy of geometry_msgs/Point for testing~%float64 x~%float64 y~%float64 z~%~%~%"))
