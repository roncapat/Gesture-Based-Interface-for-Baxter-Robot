...
(cl:defmethod cl:initialize-instance :after ((m <TestString>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestString)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_test_msgs-msg:<TestString> is deprecated: use rosjava_test_msgs-msg:TestString instead.")))
...
(cl:defmethod data-val ((m <TestString>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosjava_test_msgs-msg:data-val is deprecated.  Use rosjava_test_msgs-msg:data instead.")
  (data m))
